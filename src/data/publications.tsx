...
export const conferencesNationalInternational: Pub[] = [
  {
    ...
    title: 'From Conversations to Comparisons: The Importance of Peers for Math Motivation',
    note: '[Paper Submitted]',
    outlet: 'Annual Meeting of the American Educational Research Association',
    locationDates: 'Los Angeles, CA (Apr 8–12, 2026)',
  },
  {
    year: 2026,
    authors: 'Van Luven, W., Caybas, U., Neal, J. W., & Linnenbrink-Garcia, L.',
    title: 'Peer Recognition and Math Identity Development: A Longitudinal Network Perspective',
    note: '[Paper Submitted]',
    outlet: 'Annual Meeting of the American Educational Research Association',
    locationDates: 'Los Angeles, CA (Apr 8–12, 2026)',
  },
  {
    year: 2026,
    authors: 'Inoue, S., Van Luven, W., Caybas, U., Lee G. A., Taylor, M. R., Perez, T., & Linnenbrink-Garcia, L.',
    title: 'Longitudinal Development of Science Interest and Self-Efficacy and Their Post-College Outcomes',
    note: '[Paper Submitted]',
    outlet: 'Annual Meeting of the American Educational Research Association',
    locationDates: 'Los Angeles, CA (Apr 8–12, 2026)',
  },
  ...
  {
    year: 2025,
    authors: 'Caybas, U., Lee G. A., Van Luven, W., Inoue, S., Walton, S. P., & Linnenbrink-Garcia, L.',
    title:
  ...
  {
    year: 2025,
    authors: 'Inoue, S., Lee, G. A., Caybas, U., Van Luven, W., Walton, S. P., & Linnenbrink-Garcia, L.',
    title: 'Goal Profiles and Perceived Costs of International Asian and Asian American Students in Engineering',
  ...
  },
  {
    ...
    title: 'The Role of Academic Emotions and Belonging in Predicting Science Persistence: A Cross-Lagged Approach',
    note: '[Poster Presentation]',
    outlet: 'Annual Meeting of the American Educational Research Association',
    locationDates: 'Denver, CO (Apr 23–27, 2025)',
  },
  {
    ...
    title: 'Validating Mental Health Cost: A New Dimension of Costs in Situated Expectancy-Value Theory?',
  ...
  {
    year: 2024,
    authors: 'Keane, J., Caybas, U., Ferguson-Johnson, S., Perez, T., & Linnenbrink-Garcia, L.',
    title: 'The Power of Growth Mindsets: Enhancing Women’s Science Motivation, Persistence and Achievement.',
    note: '[Paper Presentation]',
  ...
  },
  {
    ...
    note: '[Poster Presentation]',
    outlet: 'Society for Research on Adolescence, Annual Meeting',
    locationDates: 'Chicago, IL (Apr 18–20, 2024)',
  },
  {
    year: 2024,
    authors: 'Caybas, U., Inoue, S., Van Luven, W. & Mansoor, S.',
    title: 'Arab/MENA American Students’ Belonging to College Campuses',
    note: '[Paper Presentation] — Division C Graduate Student Shark Tank Competition',
    outlet: 'Annual Meeting of the American Educational Research Association',
    locationDates: 'Philadelphia, PA (Apr 11–14, 2024)',
  },
  {
    year: 2024,
    authors: 'Caybas, U., Keane, J., Walton, S. P. & Linnenbrink-Garcia, L.',
    title: 'Attainment value as a protective factor against the adverse effects of costs',
    note: '[Paper Presentation]',
    outlet: 'Annual Meeting of the American Educational Research Association',
    locationDates: 'Philadelphia, PA (Apr 11–14, 2024)',
  },
  {
    year: 2024,
    authors: 'Keane, J., Lee, G. A., Caybas, U., Choi, G., & Linnenbrink-Garcia, L.',
    title: 'Stability of Motivation in Introductory Statistics: A Random-Intercept Latent Transition Analysis.',
    note: '[Poster Presentation]',
    outlet: 'Annual Meeting of the American Educational Research Association',
    locationDates: 'Philadelphia, PA (Apr 11–14, 2024)',
  },
  {
    year: 2023,
    authors: 'Caybas, U., Cole, A. E., Spillman, M. M.,^ Usher, E. L. & Han, J.',
    title: 'Peer Influences on Motivation: A Review of 10 Years of AERA Scholarship',
    note: '[Poster Presentation]',
    outlet: 'Annual Meeting of the American Educational Research Association',
  ...
  {
    year: 2023,
    authors: 'Caybas, U., Patterson, J. T., Spillman, M. M.,^ Cole, A. E., Han, J., Usher, E. L., & Osterhage, J.',
    title: '“We motivate one another”: Peer influences on undergraduate students’ motivation in introductory biology',
    note: '[Roundtable Presentation]',
    outlet: 'Annual Meeting of the American Educational Research Association',
    locationDates: 'Chicago, IL (Apr 13–16, 2023)',
  },
  {
    year: 2022,
    authors: 'Caybas, U., Capa-Aydin, Y., & Akkus-Cakir, N.',
    title: 'Predictors of students’ subjective task values and expectancies for success at middle school',
    note: '[Paper Presentation]',
    outlet: 'International Conference on Motivation',
  ...
  {
    year: 2022,
    authors: 'Caybas, U., Capa-Aydin, Y., & Tarim, S. D.',
    title: 'Relation between support and students’ national exam performance: The mediating role of motivation',
    note: '[Paper Presentation]',
    outlet: 'International Conference on Motivation',
    locationDates: 'Dresden, Germany (Aug 22–26, 2022)',
  },
  {
    year: 2022,
    authors: 'Osterhage, J., Caybas, U., Han, J., & Usher, E. L.',
    title:
    ...
    note: '[Paper Presentation]',
    outlet: 'Society for the Advancement of Biology Education Research',
    locationDates: 'Minneapolis, MN (Jul 7–10, 2022)',
  },
  {
    year: 2022,
    authors: 'Caybas, U., Han, J., Usher, E. L., & Osterhage J.',
    title:
  ...
  {
    year: 2021,
    authors: 'Caybas, U., Acim, S. E., Kurtcu, E., Ozenc, E., & Yavuz, B.',
    title: 'Children’s literacy club',
    note: '[Paper Presentation]',
    outlet: 'Education Reform Initiative – 18th Good Practices in Education Conference',
    locationDates: 'Istanbul, Turkey (Oct 1–8, 2021)',
  },
  {
    year: 2021,
    authors: 'Caybas, U., Akkus-Cakir, N., & Capa-Aydin, Y.',
    title: 'A study of homophily in peer group members’ academic motivation',
    note: '[Poster Presentation]',
    outlet: 'European Association for Research on Learning and Instruction Biennial Meeting',
    locationDates: 'Gothenburg, Sweden (Aug 23–27, 2021)',
  },
  {
    year: 2020,
    authors: 'Caybas, U., & Capa-Aydin, Y.',
    title: 'Development and validation of the expectancy-value scale for middle school students',
...
export const conferencesLocalRegional: Pub[] = [
  {
    year: 2022,
    authors: 'Caybas, U., Spillman, M. M.,^ Patterson, J. T., Cole, A. E., Han, J., Usher, E. L., & Osterhage, J.',
    title:
  ...
  {
    year: 2021,
    authors: 'Caybas, U., Osterhage, J., Han, J., & Usher, E. L.',
    title:
      'Instructor support during COVID-19: Relationship with undergraduate students’ motivation and achievement in STEM',
    note: '[Research Presentation]',
    outlet: 'Teaching and Learning During Covid-19 Research Symposium',
    locationDates: 'University of Kentucky, Lexington, KY (Dec 8, 2021)',
  },
];
